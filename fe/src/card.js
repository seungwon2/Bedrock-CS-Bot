  ...
  async function handleOnClick() {
    ...
    await axios
      ...
      .then(function (res) {
        ...
        setModify(
          "(This is an answer generated by AI. Please make sure to review the answer before submitting.) " +
            res.data.generated
        );}
        setLoaded(true);
        setClicked(false);
    ...
    <Wrapper>
      ...
      <Profile>
        ...
        <User>
          ...
          {props.language === "En" && (<><Badge bg="info">{props.user.purchased}-time purchase</Badge></>)}
          {props.language === "Ko" && (<><Badge bg="info">{props.user.purchased}번째 구매</Badge></>)}          
        </User>
      </Profile>
